...
import mintcode.com.workhub_im.util.BitmapUtil;
            ...
            public void run() {
                ...
                mPoolThreadHandler = new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        // 线程池去取出一个任务进行执行
                        Logger.i("handle message in thread pool");
                        if (msg.what == 0x110) {
...
//				File file = new File(filePath);
                ...
                String p = Environment.getExternalStorageDirectory() + "/launchr/send/" + UserPrefer.getImUsername() + "/"
...
//				cache.putBitmapToExtStorage("o"+filePath, localBitmap);
                ...
                msg.what = ChatActivity.HandleMsgType.TYPE_MSG_1;
