...
/**
 * @author StephenHe 2015/9/17 修改手机号
 */
...
//		mEditNewPhone.setText(phone);
	...
	public void onResponse(Object response, String taskId, boolean rawData) {
		...
		if(taskId.equals(TaskId.TASK_URL_UPDATE_USER_INFO)){
...
//			UserApi.getInstance().updateUserInfo(this, userNumber, dept,userJob, mail, userId, null, userName,newPhone);
			UserApi.getInstance().updateUserInfo(this, userNumber, dept, userJob, mail, userId, newPhone, userName, null);
		}else{
			toast(getString(R.string.my_phone_is_null));
		}
	}
