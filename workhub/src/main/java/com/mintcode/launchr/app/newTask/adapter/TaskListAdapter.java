...
public class TaskListAdapter extends BaseExpandableListAdapter{
    ...
    public TaskListAdapter(Context context, ExpandableListView expandLvTask, UpdateTaskListen listen){
        mContext = context;
        mListen = listen;
    ...
    public TaskListAdapter(Context context, List<TaskListEntity> groupList, List<List<TaskListEntity>> childList, ExpandableListView expandLvTask){
        mContext = context;
...
//        LinearLayout llChild = (LinearLayout) convertView.findViewById(R.id.ll_task_child);
        ...
        ImageView ivAttament = (ImageView)convertView.findViewById(R.id.iv_child_attament);
