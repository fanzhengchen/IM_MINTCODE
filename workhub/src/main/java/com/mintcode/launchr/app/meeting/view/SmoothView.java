...
public class SmoothView extends RelativeLayout{
...
//		getPaint(context);
	...
	private void init(Context context2) {
		post(new Runnable() {
			...
			@Override
			public void run() {
				MeetingDateView dateView = (MeetingDateView)findViewById(R.id.meeting_date_view);
				MeetingContentView contentView = (MeetingContentView)findViewById(R.id.meeting_content_view);
				MeetingPersonView personView = (MeetingPersonView)findViewById(R.id.meeting_person_view);
				
				dateView.setMeetingContentView(contentView);
				personView.setMeetingContentView(contentView);
				contentView.setMeetingDateView(dateView);
				contentView.setMeetingPersonView(personView);
			}
		});
...
//	}
	...
	public void draw(Canvas canvas) {
		...
		RectF rect = new RectF(itemWidth, 0, right, itemHeight * 6 + mTopX);
...
////			if (moveX < 0) {
////				
////				int item = TTDensityUtil.dip2px(getContext(), ITEM_WIDTH);
////				float w2 = getLeft() + ITEM_LEN * item ;
////				if (getRight()- w2 < moveX + allX) {
////					postInvalidate();
////				}else{
////					allX = getRight()- w2;
////				}
...
////			if (moveX < 0) {
////				int len = ITEM_LEN * itemWidth;
////				boolean is = len + moveX + allX   > getRight();
//////				if (getRight() - w < moveX + allX) {
//////				}
//////				else{
//////				}
////			}else {
