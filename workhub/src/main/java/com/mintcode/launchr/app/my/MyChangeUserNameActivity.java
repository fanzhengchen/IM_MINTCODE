...
/**
 * @author StephenHe 2015/9/17 修改用户名
 */
public class MyChangeUserNameActivity extends BaseActivity {
    /**
     * 返回
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_change_username);
    ...
    public void initView() {
        ...
        mEditNewPhone.setText(userName);
...
//            String newName = mEditNewPhone.getText().toString().trim();
//            AppUtil.getInstance(this).saveUserName(newName);
            setResult(RESULT_OK);
            this.finish();
        }
    ...
    private void okChange() {
        ...
        if (!"".equals(newName)) {
            UserApi.getInstance().updateUserInfo(this, userNumber, dept, userJob, mail, userId, null, newName, null);
        } else {
            toast(getString(R.string.username_null));
        }
    }
