package com.mintcode.chat.emoji;
...
//					result.append("[e]" + value + "[/e]");
	 ...
	 * @return
	 */
	public SpannableString addFace(final Context context, final int imgId,
		...
		final int x = TTDensityUtil.dip2px(context, 20.5f);
		int y = TTDensityUtil.dip2px(context,34.66f);
