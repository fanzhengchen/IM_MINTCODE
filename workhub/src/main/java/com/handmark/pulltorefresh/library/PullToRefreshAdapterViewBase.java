...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private void init(Context context) {
		...
		// footer
		int id =R.layout.listfooter_load_more;
	...
	public void addFootView() {
		((ListView)mRefreshableView).addFooterView(mFooterView);
	}
	...
	public void setStateLoadComplete() {
		...
		mTextView.setText(R.string.pull_load_more);
	...
	public void setStatePullToLoad() {
		mIsLoadingMore = false;
		mNoMore = false;
		mTextView.setText(R.string.pull_load_more);
		mProgressBarLoadMore.setVisibility(View.GONE);
	...
	public boolean isLastItemAboveBottom() {
		int lastViewBottom = mRefreshableView.getChildAt(mRefreshableView.getChildCount() - 1).getBottom();
		int listEnd = mRefreshableView.getHeight() - mRefreshableView.getPaddingBottom();
